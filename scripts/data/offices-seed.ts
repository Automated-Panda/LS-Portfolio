  ...
  return {
    ...
    upgrades: [
      ...
      },
      {
        ...
        capacity: 0,
        required_upgrade_id: null,
        notes: "Weapon loadout storage ($520,000).",
      },
      {
        id: `${loc.id}-money-safe`,
        display_name: "Safe",
        tier: null,
        capacity: 0,
        required_upgrade_id: null,
        notes: "Decorative cash safe in the office ($335,000).",
      },
      {
        id: `${loc.id}-accommodation`,
        display_name: "Accommodation",
        tier: null,
        capacity: 0,
        required_upgrade_id: null,
        notes: "Bed, shower, changing room ($795,000).",
      },
    ],
    _sources: {
